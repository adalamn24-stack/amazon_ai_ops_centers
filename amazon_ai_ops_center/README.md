...
- 项目资料中心新增文件上传与资料解析区域：
  - 支持上传 `xlsx`、`csv`、`docx`、`pdf`、`jpg`、`png`、`txt`。
  ...
  - PDF 当前只保存，不做正文解析，页面显示文件名。
  - JPG/PNG 在页面显示缩略图。
  - 当前项目已上传文件会以列表形式展示，并可展开查看预览。
...
浏览器打开 Streamlit 提示的本地地址后，即可创建产品项目、填写项目资料、上传项目文件并查看解析预览。
